...
const SOCIAL_SVG: Record<string, string> = {
  ...
  email: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 5h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zm9 8.2L4.4 7H3.8L3 7.6V8l9 7.4L21 8v-.4l-.8-.6h-.6L12 13.2zM3 8.8V18h18V8.8l-9 7.4-9-7.4z"/></svg>`,
};
